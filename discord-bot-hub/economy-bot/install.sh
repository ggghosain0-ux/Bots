...
configure_pm2() {
  ...
  pm2 start src/index.js --name economy-bot
  pm2 save
...
main() {
  ...
  configure_firewall
  configure_pm2
  echo "\nEconomy Bot installed successfully!"
  echo "Commands:"
  echo "  pm2 status economy-bot"
  echo "  pm2 restart economy-bot"
  echo "  pm2 stop economy-bot"
  echo "  pm2 delete economy-bot"
  echo "  pm2 logs economy-bot"
}
