...
main() {
  ...
  configure_firewall
  configure_pm2
  echo "\nTicket Bot installed successfully!"
  echo "Commands:"
  echo "  pm2 status ticket-bot"
  echo "  pm2 restart ticket-bot"
  echo "  pm2 stop ticket-bot"
  echo "  pm2 delete ticket-bot"
  echo "  pm2 logs ticket-bot"
}
