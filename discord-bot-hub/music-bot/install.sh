...
main() {
  ...
  configure_firewall
  configure_pm2
  echo "\nMusic Bot installed successfully!"
  echo "Commands:"
  echo "  pm2 status music-bot"
  echo "  pm2 restart music-bot"
  echo "  pm2 stop music-bot"
  echo "  pm2 delete music-bot"
  echo "  pm2 logs music-bot"
}
