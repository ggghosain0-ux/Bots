...
configure_pm2() {
  ...
  pm2 start src/index.js --name marketplace-bot
  pm2 save
...
main() {
  ...
  configure_firewall
  configure_pm2
  echo "\nMarketplace Bot installed successfully!"
  echo "Commands:"
  echo "  pm2 status marketplace-bot"
  echo "  pm2 restart marketplace-bot"
  echo "  pm2 stop marketplace-bot"
  echo "  pm2 delete marketplace-bot"
  echo "  pm2 logs marketplace-bot"
}
