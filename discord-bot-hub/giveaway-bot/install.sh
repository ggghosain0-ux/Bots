...
main() {
  ...
  configure_firewall
  configure_pm2
  echo "\nGiveaway Bot installed successfully!"
  echo "Commands:"
  echo "  pm2 status giveaway-bot"
  echo "  pm2 restart giveaway-bot"
  echo "  pm2 stop giveaway-bot"
  echo "  pm2 delete giveaway-bot"
  echo "  pm2 logs giveaway-bot"
}
