...
configure_pm2() {
  ...
  pm2 start src/index.js --name utility-bot
  pm2 save
...
main() {
  ...
  configure_firewall
  configure_pm2
  echo "\nUtility Bot installed successfully!"
  echo "Commands:"
  echo "  pm2 status utility-bot"
  echo "  pm2 restart utility-bot"
  echo "  pm2 stop utility-bot"
  echo "  pm2 delete utility-bot"
  echo "  pm2 logs utility-bot"
}
