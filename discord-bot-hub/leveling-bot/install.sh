...
configure_pm2() {
  ...
  pm2 start src/index.js --name leveling-bot
  pm2 save
...
main() {
  ...
  configure_firewall
  configure_pm2
  echo "\nLeveling Bot installed successfully!"
  echo "Commands:"
  echo "  pm2 status leveling-bot"
  echo "  pm2 restart leveling-bot"
  echo "  pm2 stop leveling-bot"
  echo "  pm2 delete leveling-bot"
  echo "  pm2 logs leveling-bot"
}
